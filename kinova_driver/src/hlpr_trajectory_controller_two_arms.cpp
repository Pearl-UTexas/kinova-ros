#include <kinova_driver/jaco_trajectory_controller_two_arms.h>
  ...
  smoothTrajectoryServer(pnh, "trajectory", boost::bind(&JacoTrajectoryController::executeSmoothTrajectory, this, _1), false)
{
  ...
  jointNames.push_back(side_ + "_joint_2");
  jointNames.push_back(side_ + "_joint_3");
  jointNames.push_back(side_ + "_joint_4");
  jointNames.push_back(side_ + "_joint_5");
  jointNames.push_back(side_ + "_joint_6");
  jointNames.push_back(side_ + "_joint_7");
